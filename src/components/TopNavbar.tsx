      ...
      <div className="container px-4 mx-auto max-w-[1400px]">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <Link href="/" onClick={onHomeClick} className="text-xs font-bold uppercase tracking-widest text-white/90 hover:text-[#06B6D4] transition-colors">DASHBOARD</Link>
            {hasSteamDeals && <Link href="/free-steam-games" onClick={onFreeGamesClick} className="text-xs font-bold uppercase tracking-widest text-[#9CA3AF] hover:text-[#8B5CF6] transition-colors relative group"><span className="absolute -inset-2 bg-[#8B5CF6]/10 opacity-0 group-hover:opacity-100 rounded blur-sm transition-opacity"></span>ASSET MAP</Link>}
            {hasEpicDeals && <Link href="/free-epic-games" onClick={onFreeGamesClick} className="text-xs font-bold uppercase tracking-widest text-[#9CA3AF] hover:text-[#EC4899] transition-colors relative group"><span className="absolute -inset-2 bg-[#EC4899]/10 opacity-0 group-hover:opacity-100 rounded blur-sm transition-opacity"></span>MARKET SURVEILLANCE</Link>}
            {hasGogDeals && <Link href="/free-gog-games" onClick={onFreeGamesClick} className="text-xs font-bold uppercase tracking-widest text-[#9CA3AF] hover:text-white transition-colors relative group"><span className="absolute -inset-2 bg-white/10 opacity-0 group-hover:opacity-100 rounded blur-sm transition-opacity"></span>INTEL ARCHIVE</Link>}
          </div>
