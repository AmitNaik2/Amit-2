          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-[10px] uppercase font-orbitron tracking-widest font-bold text-[#9CA3AF]">
            <div className="flex flex-col gap-4">
             ...
             <div className="flex flex-col gap-4">
               ...
               <Link href="/terms" className="text-left py-1 hover:text-[#06B6D4] hover:scale-105 origin-left transition-all">Terms of Service</Link>
               <Link href="/privacy" className="text-left py-1 hover:text-[#06B6D4] hover:scale-105 origin-left transition-all">Privacy Directive</Link>
               <Link href="/privacy" className="text-left py-1 hover:text-[#06B6D4] hover:scale-105 origin-left transition-all">Cookie Directive</Link>
            </div>
             <div className="flex flex-col gap-4">
               ...
               <Link href="/contact" className="text-left py-1 hover:text-[#06B6D4] hover:scale-105 origin-left transition-all">Secure Comms Request</Link>
               <Link href="/about" className="text-left py-1 hover:text-[#06B6D4] hover:scale-105 origin-left transition-all">Project Logs</Link>
            </div>
            <div className="flex flex-col gap-4">
               ...
               <div className="mt-8 pt-4 border-t border-white/10 opacity-40 font-mono tracking-tighter">Â© 2026 GAMESDEALSHUB</div>
            </div>
          </div>
        </div>
      </footer>
